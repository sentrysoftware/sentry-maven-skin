...
(function () {
	 ...
	 **/
	angular.module("sentry.site").directive("copyToClipboard", [
		"$document",
		"$window",
		"$timeout",
		function ($document, $window, $timeout) {
			return {
				...
				link: function (scope, element) {
					...
					var btnEl = angular.element(
						"<button type='button' title='Copy to clipboard' class='btn btn-default hidden-xs'><i class='fas fa-clipboard'></i> Copy</button>"
					);
